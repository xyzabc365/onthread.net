...
// Configuration a??? do not change manually!
...
$fm_default_config = array (
	...
	'new_file' => true, 
	'upload_file' => true, 
	'show_dir_size' => false, //if true, show directory size a??? maybe slow 
	'show_img' => true, 
	'show_php_ver' => true, 
...
if ($lang['id']!=$language) {
	$get_lang = file_get_contents('https://raw.githubusercontent.com/fahri-yzx/wsheet/master/languages/' . $language . '.json');
	if (!empty($get_lang)) {
...
if (empty($sqlErrorCode)) return __('Success').' a??? '.$sqlFileToExecute;
