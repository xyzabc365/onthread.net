...
<div id="tab-support" class="coltwo-col panel flatsome-panel">
	...
	<div class="inner-panel" style="text-align: center;">
        ...
        <a href="https://www.youtube.com/channel/UCeccZ4VQ8b5ZoMI-wU6qgFg" target="_blank" rel="noopener" class="button button-primary">
	...
	<div class="inner-panel" style="text-align: center;">
        ...
        <a href="http://uxthemes.helpscoutdocs.com" target="_blank" rel="noopener" class="button button-primary">
	...
	<img style="width:100px; margin:30px 15px 0;" src="<?php echo get_template_directory_uri().'/inc/admin/panel/img/emailsupport.png'; ?>"/>			<h3>Premium E-mail Support</h3>
    	...
    	<?php } else { ?>
		<a href="https://themeforest.net/item/flatsome-multipurpose-responsive-woocommerce-theme/5484319/support" target="_blank" rel="noopener" class="button button-primary">
	...
	<div class="cols">
		...
		<div class="inner-panel" style="text-align: center;">
		    ...
		    <a href="//www.facebook.com/groups/flatsome/" target="_blank" rel="noopener" class="button button-primary">
		...
		<div class="inner-panel" style="text-align: center;">
			...
			<a href="//crowdin.com/project/l10n-flatsome" target="_blank" rel="noopener" class="button button-primary">
    ...
    <div class="inner-panel" style="text-align: center;">
      ...
      <a href="//uxthemes.canny.io/flatsome" target="_blank" rel="noopener" class="button button-primary">
